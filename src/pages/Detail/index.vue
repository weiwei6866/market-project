        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(obj, index) in spuSaleAttrList" :key="index">
                <dt class="title">{{ obj.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValue.isChecked == 1 }"
                  v-for="spuSaleAttrValue in obj.spuSaleAttrValueList"
                  :key="spuSaleAttrValue.id"
                  @click="changeActive(obj.spuSaleAttrValueList,spuSaleAttrValue)"
                >
...
export default {
  ...
  methods: {
    changeActive(spuSaleAttrValueAll,spuSaleAttrValue){
      console.log(spuSaleAttrValue);
      spuSaleAttrValueAll.forEach(element => {
          element.isChecked = 0
      });
    ...
    async addCart(){
      try {
        this.$store.dispatch('sendIdAndNum',{skuId:this.$route.params.skuid,skuNum:this.skuNum})
      //发送请求 发产品id和数量
